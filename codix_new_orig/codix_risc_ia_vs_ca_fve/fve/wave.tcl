...
proc icodix_risc_ca_core_regs_t { PATH ID RTL_PATH } {
...
proc icodix_risc_ca_core_main_instr_hw_instr_hw_t { PATH ID } {
	add wave -noupdate -divider "$ID interface:"
...
proc icodasip_memory_mem_t { PATH ID } {
	add wave -noupdate -divider "$ID interface:"
...
proc icodix_risc_platform_ca_t { PATH ID } {
}
...
proc customize_gui { DUT_MODULE HDL_DUT } {
	...
	icodix_risc_ca_core_regs_t $DUT_MODULE/codix_risc_platform_ca_codix_risc_core_regs_if codix_risc_platform_ca_codix_risc_core_regs_if /top/dut/HDL_DUT_U/codix_risc/core/regs/RAM
	icodix_risc_ca_core_main_instr_hw_instr_hw_t $DUT_MODULE/codix_risc_platform_ca_codix_risc_core_main_instr_hw_instr_hw_if codix_risc_platform_ca_codix_risc_core_main_instr_hw_instr_hw_if
	icodix_risc_ca_t $DUT_MODULE/codix_risc_platform_ca_codix_risc_if codix_risc_platform_ca_codix_risc_if
	icodasip_memory_mem_t $DUT_MODULE/codix_risc_platform_ca_mem_if codix_risc_platform_ca_mem_if
	ihalt $DUT_MODULE/ihalt_if ihalt_if
	icodix_risc_platform_ca_t $DUT_MODULE/codix_risc_platform_ca_if codix_risc_platform_ca_if
